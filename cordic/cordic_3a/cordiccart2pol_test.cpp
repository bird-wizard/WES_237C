...
void run_test(xy_t x, xy_t y, double golden_theta, double golden_r)
{
	r_t r;
	theta_t theta;
...
int main()
{
	...
	run_test(1.0, 0.0, 0.0, 1.0);
	run_test(0.0, 1.0, 1.57079633, 1.0);
	run_test(-1.0, 0.0, 3.14159265, 1.0);
	run_test(0.0, -1.0, -1.57079633, 1.0);
	run_test(1.0, 1.0, 0.78539816, 1.41421356);
	run_test(-1.0, 1.0, 2.35619449, 1.41421356);
	run_test(-1.0, -1.0, -2.35619449, 1.41421356);
	run_test(1.0, -1.0, -0.78539816, 1.41421356);
