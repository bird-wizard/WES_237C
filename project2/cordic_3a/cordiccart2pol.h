...
// Question 2c:
// Use 16,3 for all variables.
// Experiment with only Kvalues and angles.
// Use 4, 8, 12, 16, 20, 32 total bits.

// Question 3a:
// Use only add and shift instead of multiply and divide.
// Use 8, 12, 16, 20, 24, and 32 total bits.
typedef ap_fixed<32,3> data_t;
typedef ap_fixed<32,3> tables_t;
